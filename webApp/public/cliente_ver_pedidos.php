...
if (isset($_SESSION['usuario']) && $_SESSION['tipo_usuario'] === 'cliente') {
    ...
    $PageTitle = "Librería Pessoa - Mis Pedidos";
        ...
        <div class="container">
            ...
            if (empty($ordenes)): ?>
                <div class="card border-0 shadow-sm rounded-3 p-5 text-center">
                    <h4 class="text-black-50">No tienes pedidos aún</h4>
                    <p>¡Visita nuestra tienda y realiza tu primer pedido!</p>
                    <div class="mt-3">
                        <a href="cliente_vista.php" class="btn">Ir a la tienda</a>
                    </div>
                </div>
            <?php else: ?>
                <div class="accordion" id="accordionPedidos">
                    ...
                    foreach ($ordenes as $orden): ?>
                        ...
                        <div class="accordion-item border-0 shadow-sm rounded-3 mb-3">
                            ...
                            <div id="collapse-<?= $i ?>" class="accordion-collapse collapse <?php if ($i == 1) print('show') ?>" data-bs-parent="#accordionPedidos">
